...
export default function OurPrinciple() {
  ...
  return (
    <section
      id="principals"
      className="relative py-20 md:py-28 px-4 md:px-6 bg-[#0B1120] overflow-hidden"
    >
      {/* Ambient glows */}
              ...
              <div className="relative min-h-[260px] lg:min-h-[380px] overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.parentElement.style.background = `linear-gradient(135deg, ${current.color}15 0%, ${current.color}08 100%)`;
                  }}
                />
                ...
                {current.stats && current.stats.length > 0 && (
                  <div className="absolute bottom-5 right-5 z-10 hidden md:flex gap-2">
                    {current.stats.map((s, i) => (
                      <div
                        key={i}
                        className="bg-black/40 backdrop-blur-md rounded-xl px-3.5 py-2 border border-white/10 text-center min-w-[80px]"
                      >
                        <div
                        ...
                        <div className="text-[10px] text-slate-300 mt-1 leading-tight font-medium max-w-[100px]">
                          {s.label[lang]}
                        </div>
                      </div>
                    ))}
        ...
        <div className="flex justify-center gap-2.5 mt-10">
          {principals.map((_, i) => (
            <button
              ...
              style={{
                backgroundColor: active === i ? current.color : undefined,
              }}
            />
          ))}
        </div>
